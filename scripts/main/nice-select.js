		...
		return (
			...
			(u.prototype.extractData = function () {
				...
				e.forEach(e => {
					...
					else s = { text: e.innerText, value: e.value, selected: null != e.getAttribute('selected') || this.el.value == e.value, disabled: null != e.getAttribute('disabled') };
			...
			(u.prototype._onClicked = function (e) {
				...
				if (
					...
					a(this.dropdown, 'open')
						...
						: (c(this.dropdown, 'open'), (t = this.el), (i = document.createEvent('UIEvent')).initEvent('modalopen', !0, !1), t.dispatchEvent(i)),
					a(this.dropdown, 'open'))
				) {
